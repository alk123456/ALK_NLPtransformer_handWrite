...
class CoupleDataset(Dataset):
    def __init__(self, path):
        ...
        in_data = open(os.path.join(path, "in.txt"), encoding='utf-8').readlines()
        out_data = open(os.path.join(path, "out.txt"), encoding='utf-8').readlines()
